...
const Card: FC<iCardProps> = ({
	...
	return (
		<div className="h-screen flex items-center justify-center sticky top-0 md:p-0 px-4">
			<div
				className="relative flex flex-col h-[300px] w-[700px] py-12 px-10 items-center justify-center mx-auto 
			...
			>
				...
				<div className="absolute inset-0 z-0 w-full" style={{ aspectRatio: "2 / 1" }}>
                    <Image
                        src={src}
                        alt="Background"
                        fill
